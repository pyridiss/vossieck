    ...
    : QWidget(parent)
{
    ...
    QLabel* labelHaus    = new QLabel(tr("<span style='font-size:20pt;'>Wohnsituation</span>"));
    QLabel* labelEigen   = new QLabel(tr("<span style='font-size:20pt;'>Eigentümer / Miete</span>"));
    ...
    QLabel* labelSurface   = new QLabel(tr("Floor surface:")); labelSurface->setAlignment(Qt::AlignRight | Qt::AlignVCenter);
